...
function main() {
  ...
  if (eventName === "SessionStart") emitOutput({ hook: "claude.SessionStart", workspaceRoot: resolveWorkspaceRoot(cwd), timestamp: nowIso() });
  else if (eventName === "SessionEnd") emitOutput({ hook: "claude.SessionEnd", workspaceRoot: resolveWorkspaceRoot(cwd), timestamp: nowIso() });
}
main();